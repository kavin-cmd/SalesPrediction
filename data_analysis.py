...
def analyze_data(file_path='./output/all_data_master.csv'):
    ...
    plt.savefig("./img/01_months_sales.png", bbox_inches='tight', dpi=300)
    plt.show()
    ...
    plt.savefig("./img/02_city_sales.png", bbox_inches='tight', dpi=300)
    plt.show()

    # Question 3: Best time to advertise
    ...
    plt.savefig("./img/03_hour_sales.png", bbox_inches='tight', dpi=300)
    plt.show()
    ...
    plt.savefig("./img/04_most_product.png", bbox_inches='tight', dpi=300)
    plt.show()
    ...
    plt.savefig("./img/05_most_product_price.png", bbox_inches='tight', dpi=300)
    plt.show()
